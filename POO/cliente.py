...
class Cliente:
    ...
    # self para referência a própria estrutura de classe a qual
    # ele pertence
    ...
    '''
    A classe Cliente gera novos clientes e pede alguns dados
    ...
    def dados(self,nome="",idade=0,genero="",email=""):
        '''
        O método dados pede algumas informações do cliente para que
        ele seja salvo no sistema
        '''
        self.__nome = nome
        self.__idade = idade
    ...
    # O método gravar exibir uma mensagem com o nome do cliente
